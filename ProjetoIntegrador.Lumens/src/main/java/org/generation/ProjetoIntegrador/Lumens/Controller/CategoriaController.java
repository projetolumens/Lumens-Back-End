...
public class CategoriaController {
	...
	@GetMapping("/grupoDescarte/{grupoDescarte}")
	public ResponseEntity<List<CategoriaModel>> getByGrupoDescarte(@PathVariable String grupoDescarte) {

		return ResponseEntity.ok(categoriaRepository.findAllByGrupoDescarteContainingIgnoreCase(grupoDescarte));
	}
